...
admin_username = 'evamuriithi'
admin_password = 'EthanNeema2!'
...
description  = f'User added by {admin_username} via python selenium Automated script on {datetime.datetime.now()}'
...
lst_opt = ['Web page', 'ICQ number', 'Skype ID', 'AIM ID', 'Yahoo ID', 'MSN ID', 'ID number', 'Institution', 'Department',
          'Phone', 'Mobile phone', 'Address']

lst_ids = ['id_url', 'id_icq','id_skype','id_aim','id_yahoo','id_msn','id_idnumber', 'id_institution','id_department','id_phone1','id_phone2', 'id_address']

lst_val = [webpage, icq_num, id_skype, id_aim, id_yahoo, id_msn, id_idnumber, id_institution, id_department, phonenum1, phonenum2, address]
